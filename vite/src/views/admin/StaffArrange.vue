    ...
    <el-dialog v-model="dialogVisible" title="新增人员分配" width="500px" destroy-on-close>
      <el-form ref="formRef" :model="formData" :rules="formRules" label-width="100px">
        <el-form-item label="选择订单" prop="orderId">
          <el-select v-model="formData.orderId" filterable placeholder="请选择订单" style="width: 100%">
...
import { getOrderStaffList, addOrderStaff, deleteOrderStaff, getStaffList, getOrderList } from '@/api/index.js'
...
const formData = reactive({ orderId: null, staffId: null, staffRole: null })
...
const handleAdd = () => {
  Object.assign(formData, { orderId: null, staffId: null, staffRole: null })
  loadOptions()
